...
//     constructor(readonly power) { // 접근 제어자(pubic, private, protected, readonly)가 붙으면 생성자 멤버 변수 생략!
//         this.power=power
//     }
//    /**
...
// const myMonster55 = new FlyMonster5(100)

// myMonster55.attack1()
// myMonster55.attack2()
// console.log(myMonster55.power) // 밖에서 접근 가능
// myMonster55.power=10 // 밖에서 수정 불가
