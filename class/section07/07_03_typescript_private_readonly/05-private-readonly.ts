...
//     constructor(private readonly power) { // 접근 제어자(pubic, private, protected, readonly)가 붙으면 생성자 멤버 변수 생략!
//         this.power=power
//     }
//    /**
...
//      *  5) private readonly: 본인수정 ❌, 본인접근 ⭕️, 자식수정 ❌, 자식접근 ❌, 인스턴스로 생성자 멤버 변수 값 수정 ❌, 값 접근 ❌
//      *     => ⭐️ 안전한 프로그래밍을 위해 Nestjs에서 지향하는 방식
//    */
...
// class FlyMonster6 extends Monster6{
//   attack2 = ()=> {
//         console.log("공격!!")
...
// const myMonster66 = new FlyMonster6(100)

// myMonster66.attack1()
// myMonster66.attack2()
// console.log(myMonster66.power) // 밖에서 접근 불가
// myMonster66.power=10 // 밖에서 수정 불가
